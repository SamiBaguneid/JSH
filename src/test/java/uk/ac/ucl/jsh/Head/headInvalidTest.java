...
public class headInvalidTest {
    ...
    public headInvalidTest() throws IOException {
    ...
    {
        jsh.eval.eval("head -q 10 file1.txt", out);
    }

    @Test(expected = Exception.class)
    public void invalidNumberOfLines() throws Exception
    {
        jsh.eval.eval("head -n HARDEN file1.txt", out);
    }

    @Test(expected = Exception.class)
    public void missingNumberOfLines() throws Exception
    {
        jsh.eval.eval("head -n file1.txt", out);
    }
