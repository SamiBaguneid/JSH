...
public class tailOptionsTest {
    ...
    public tailOptionsTest() throws IOException {
    ...
    {
        jsh.eval.eval("tail -n 7 file1.txt", out);
    ...
    public void testExactlyN() throws Exception {
        jsh.eval.eval("tail -n 30 file1.txt", out);
    ...
    {
        jsh.eval.eval("tail -n 6 file2.txt", out);
        assertEquals("Line (01)", scn.nextLine());
        assertEquals("Line (02)", scn.nextLine());
        assertEquals("Line (03)", scn.nextLine());
        assertEquals("Line (04)", scn.nextLine());
    ...
    {
        jsh.eval.eval("tail -n 0 file1.txt", out);
    ...
    {
        jsh.eval.eval("tail -n 65 file4.txt", out);
        assertEquals("", scn.nextLine());
    }
